...
![已持续维护](https://img.shields.io/badge/📅%20已持续维护-367天-brightgreen?style=flat-square)
...
* **⚡ 硬件加速解码**：内置网页播放器，完美支持 Intel/AMD 核显（QSV/VAAPI）与 NVIDIA 显卡硬件加速转码，无需 Jellyfin/Emby 即可在线流畅播放。
